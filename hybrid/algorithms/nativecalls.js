/*
	nativecalls
	Static analysis algorithm that only resolves native function calls that call user functions (i.e. addEventListeners' second parameter is a function that gets called when it triggers).
